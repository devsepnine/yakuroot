...
public class PlayerDto {
	...
	public void setData(ResultSet rs) throws SQLException {
		...
		this.setP_club_no(rs.getInt("p_club_no"));
	...
	public int getP_club_no() {
		return p_club_no;
	}

	public void setP_club_no(int p_club_no) {
		this.p_club_no = p_club_no;
	}
	...
	public String toString() {
		return "PlayerDto [p_no=" + p_no + ", p_club_no=" + p_club_no + ", p_club=" + p_club + ", p_photo=" + p_photo
				+ ", p_name=" + p_name + ", p_bnum=" + p_bnum + ", p_birth=" + p_birth + ", p_height=" + p_height
				+ ", p_weight=" + p_weight + ", p_position=" + p_position + "]";
	}
