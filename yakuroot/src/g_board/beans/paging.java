...
public class paging {
	...
	private List<g_boardDto> list; //데이터가 저장된 목록
	public void calculate() throws Exception{
      	...
      	this.count = gdao.getCount(type,keyword);     	
      	...
      	if(search){
      		list = gdao.search(type,keyword,start,end); 				
      	}else{
      		list = gdao.list(start,end);
      	}
	...
	public List<g_boardDto> getList() {
		return list;
	}
