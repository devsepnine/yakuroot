...
@WebServlet(urlPatterns="/board/n_download.do")
public class n_board_download extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String n_savename = req.getParameter("n_savename");
		n_boardDao ndao = new n_boardDao();
		n_boardDto ndto = ndao.getdown(n_savename);
...
//		resp.setHeader("Content-Type", "application/octet-stream; charset=UTF-8");
		...
		resp.setHeader("Content-Disposition", "attachment; filename="+ndto.getSendname());
		resp.setHeader("Content-Length", String.valueOf(ndto.getN_len()));
		resp.setHeader("COntent-Description", "부연설명");
		
		File target = new File("D:/n_upload/"+ndto.getN_savename());
