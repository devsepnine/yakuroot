...
public class MatchDto {
	...
	public int getM_team1() {
		return m_team1;
	}
	public void setM_team1(int m_team1) {
		this.m_team1 = m_team1;
	}
	public int getM_team2() {
		return m_team2;
	}
	public void setM_team2(int m_team2) {
	...
	public String toString() {
		return "MatchDto [match_no=" + match_no + ", m_date=" + m_date + ", m_team1=" + m_team1 + ", m_team2=" + m_team2
				+ ", m_point1=" + m_point1 + ", m_point2=" + m_point2 + ", m_stadium=" + m_stadium + "]";
	}
	public MatchDto() {
		super();
	}
	...
	public MatchDto(ResultSet rs) throws SQLException {
		...
		this.setM_team1(rs.getInt("m_team1"));
		this.setM_team2(rs.getInt("m_team2"));
