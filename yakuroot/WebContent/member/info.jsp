				...
				<legend>${mdto.name}님의 정보</legend>
					<table border = 1 width = 80% align = "center" class="table table-noline">
						<tbody>
					   		...
					   		<tr>
					   		<td><a href ="change_info.do"><input type="button" value="내 정보 수정" name="edit"></a></td>
					   		<td><a href ="delete.do"><input type="button" value="회원 탈퇴" name="exit"></a></td>
					   		</tr>
						</tbody>
					</table>
			</fieldset>
